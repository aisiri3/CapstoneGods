...
def generate_llama_response(prompt, persona=None, avatar_config=None):
    ...
    sensitive_words = ['kill','hate','violent','harm']

    if any(word in prompt.lower() for word in sensitive_words):
        answer_text= "Sorry, I am afraid I am unable to answer you. Please ask questions related to language learning."
        return answer_text
    print("im here!!!!")
    ...
    # Map gender to name for English language
    name_mapping = {
        ("Male", "English"): "Adam",
        ("Male", "Malay"): "Hakim",
        ("Female", "English"): "Lana",
    ...
    # Get the appropriate name with fallback to default
    assistant_name = name_mapping.get((gender, language), "Assistant")
    ...
    if persona_context == "Casual":
        persona = (
            ...
            f"You are {assistant_name}, English language assistant helping learners improve their communication skills in casual, everyday settings."
        ...
        persona = (
            "DO NOT CONTINUE THE PROMPT!!!"
            f"You are {assistant_name},  English language assistant helping professionals improve their communication skills in the workplace. Please provide clear, concise, and formal responses with examples appropriate for a business setting." 
        ...
        persona = (
           f"I am {assistant_name}, English learning assistant, ready to adapt to your needs. "
