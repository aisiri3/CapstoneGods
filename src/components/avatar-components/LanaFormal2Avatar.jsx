/**
 * Lana Avatar Component (Professional)
 * 
 * Renders Lana, the avatar for English, Female, Professional settings.
...
export function Lana2Formal({ lipSyncData, audioUrl, position, rotation, scale, isFiller }) {
  ...
  const { animations: idleAnimation } = useFBX("/animations/lana/Lana_Idle.fbx")
  const { animations: talkingAnimation } = useFBX("/animations/lana/Lana_Talking.fbx")
  const { animations: wavingAnimation } = useFBX("/animations/lana/Lana_Waving.fbx")
